...
const QUIZ = [
    ...
    {
        q: 'כמה זמן מאיה וירין ביחד נכון ליום החתונה?',
        options: [
            '5 שנים ו-344 ימים',
            '6 שנים ו-4 ימים',
            'תלוי מאיזה יום סופרים',
            'אין גרסה אחת מדוייקת מה שבטוח זה שמאיה לא מיקבלה בין ירין לבין האקס'
        ],
        correct: 3
    },
    {
        q: 'מי אחראי על הסדר והניקיון בבית?',
        options: [
            'ירין אחראי על הכל',
            'מאיה אחראית על הכל',
            'אין סדר בבית',
            'פעם בחודש בא אלווין ומאפס את המקום'
        ],
        correct: 3
    },
    {
        q: 'מה משותף לאבות של מאיה וירין?',
        options: [
            'שניהם שיחקו באותה קבוצה ב-NBA, ליגת הכדורסל הטובה בעולם',
            'שניהם הצליחו לשרוד משחק שחמט עם גארי קספרוב וסיימו בתיקו',
            'שניהם היו יחד בצבא פולין בסיירת הנגמשים',
            'שניהם שירתו כחובלים בחיל הים'
        ],
        correct: 3
    },
    {
        q: 'מה משותף לאמהות של מאיה וירין?',
        options: [
            'הן הכירו עוד בצעירותן בליגת הנוער לכדורעף כיריבות מושבעות - שרון, אמא של ירין, כקפטנית המיתולוגית של אפרוחי קריית אתא, ויהודית, אמא של מאיה, כמלכת ההנחתות של בנות גבעת עוז',
            'הכירו בצבא - יהודית הדריכה בטיול ששרון הגיעה אליו עם התזמורת בה שירתה',
            'לימדו ביחד עברית ב-Hebrew School בניו יורק',
            'שתיהן נראות בנות 40 במקסימום'
        ],
        correct: 3
    }
];
